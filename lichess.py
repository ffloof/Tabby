...
dark = (181, 136, 99,255)
light_green = (205, 210, 106,255)
dark_green = (170, 162, 58,255)
...
while True:
    if (playingWhite == (board.turn == chess.WHITE)):
        if allowEngine:
            ...
            auto.click(move_start_x, move_start_y)
            #auto.moveTo(, move_end_y) #, duration=moveTime + numpy.random.exponential(moveNoise), tween=auto.easeInOutQuad)
            auto.click(move_end_x, move_end_y)
